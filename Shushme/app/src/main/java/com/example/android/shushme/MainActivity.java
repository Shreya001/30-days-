...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEnabled = getPreferences(MODE_PRIVATE).getBoolean("setting_enabled",false);
        onoffSwitch.setChecked(mEnabled);
        onoffSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                SharedPreferences.Editor editor = getPreferences(MODE_PRIVATE).edit();
                editor.putBoolean("setting_enabled",b);
                mEnabled = b;
                editor.commit();
                if(b)mGeofencing.registerGeofences();
    ...
    public void refreshPlacesData() {
        ...
        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
            ...
            public void onResult(@NonNull PlaceBuffer places) {
                ...
                if(mEnabled)mGeofencing.registerGeofences();
            }
        });
    }
